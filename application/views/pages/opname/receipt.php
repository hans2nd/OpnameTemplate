<div class="content-wrapper">
	...
	<section class="content">
		<form action="<?= site_url('Opname/process3') ?>" method="post" id="quickForm">
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group row <?= form_error('inputLocation') ? 'has-error' : null ?>">
						...
						<div class="col-sm-2">
							<!-- <input type="text" class="form-control" value="" id="inputLocation" name="inputLocation" placeholder="Location ID"> -->
							<select id="inputLocation" class="form-control select2bs4" name="inputLocation">
								<option value="">&nbsp;</option>
