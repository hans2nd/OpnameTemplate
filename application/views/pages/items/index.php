<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
			...
			?>
			<div class="card">
				<form action="<?= site_url('Item/ProcessSelected') ?>" method="POST">
					<div class="card-header border-0">
						<h3 class="card-title">
							<a href="<?= site_url('Item/addItem') ?>" class="btn btn-success btn-sm"><i class="fas fa-plus-square mr-1"></i>
								Add Item
							</a>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td><?= $row['looseuom']; ?></td>
										<td>
											<a class="btn btn-xs btn-warning" href="<?= site_url('Item/editItem/' . $row['id']) ?>">
												<i class="fas fa-edit"></i> Edit
											</a>
											<a class="btn btn-xs btn-danger" href="<?= site_url('Item/deleteItem/' . $row['id']) ?>" onclick="confirmation(event)">
...
<div class="modal fade" id="modal-default">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="<?= site_url('Item/uploadExcel') ?>" method="post" enctype="multipart/form-data">
				...
				<div class="modal-body justify-content-between">
					...
					<div class="modal-footer justify-content-between">
						...
						<a href="<?= site_url('Item/downloadTemplate'); ?>" class="btn btn-success">Download Template</a>
					</div>
				</div>
			</form>
	</div>
